...
ros2 run nmpc_acados_px4 run_node --platform sim --trajectory fig8_akash --double-speed --log
ros2 run nmpc_acados_px4 run_node --platform sim --trajectory fig8_akash --double-speed --ff --log
```
...
ros2 run nmpc_acados_px4 run_node --platform sim --trajectory fig8_akash --double-speed --pyjoules --log
ros2 run nmpc_acados_px4 run_node --platform sim --trajectory fig8_akash --double-speed --ff --pyjoules --log
```
